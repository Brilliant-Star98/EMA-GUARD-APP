...
import com.optisoft.emaguard.Model.DropDownUsers;
...
public class SearchableSpinner extends AppCompatAutoCompleteTextView implements View.OnClickListener, View.OnFocusChangeListener, AppCompatAutoCompleteTextView.Validator, AdapterView.OnItemClickListener {
     ...
     */
    private ArrayList<DropDownUsers> data;
     ...
     */
    public void setData(ArrayList<DropDownUsers> data) {
        this.data = data;
        setAdapter(this.data);
    }
     ...
     */
    private void setAdapter(ArrayList<DropDownUsers> data) {
        ArrayAdapter<DropDownUsers> adapter = new ArrayAdapter<>(getContext(), android.R.layout.simple_spinner_dropdown_item, data);
        setAdapter(adapter);
    }
    ...
    public void setInvalidTextColor(@ColorInt int invalidTextColor) {
        ...
        setTextColor(invalidTextColor);
        setPadding(10,20,0, 35);
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
       // selectionListener.onSelect(getId(), position, (String) parent.getItemAtPosition(position));
        selectionListener.onSelect(getId(), position, data.get(position));
    }
    ...
    public interface OnSelectionListener {
         ...
         */
        void onSelect(int spinnerId, int position, DropDownUsers value);
    }
}